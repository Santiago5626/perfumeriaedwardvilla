...
@section('title', 'Registro - Edward Villa Perfumería')
        ...
        <div class="col-12 col-md-10 col-lg-8 col-xl-7">
            <div class="auth-card">
                <div class="auth-header">
                    ...
                    <p class="auth-subtitle">Únete a nuestra exclusiva comunidad</p>
                </div>
                ...
                <div class="auth-footer">
                    <p class="text-center">
                        ...
                        <a href="{{ route('login') }}" class="auth-link-primary">Inicia sesión aquí</a>
                    </p>
                </div>
            </div>
        </div>
